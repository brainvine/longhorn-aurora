...
function App() {
  ...
  const handleExportHTML = useCallback(() => {
    exportToHTML({ speed, hueShift, saturation, showWatermark, theme });
  }, [speed, hueShift, saturation, showWatermark, theme]);
  ...
  return (
    ...
    >
      <AuroraCanvas
        ...
        canvasRef={canvasRef}
      />
      {!isWallpaperMode && <Watermark visible={showWatermark} />}
      {!isWallpaperMode && (
        <ControlPanel
